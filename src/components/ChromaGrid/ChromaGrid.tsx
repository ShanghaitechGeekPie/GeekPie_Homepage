    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex md:flex-col md:h-auto w-full md:w-[300px] rounded-[20px] overflow-hidden border-none border-transparent transition-colors duration-300 cursor-pointer"
          style={
            {
        ...
        >
          ...
          />
          <div className="relative z-10 md:flex-1 p-[10px] box-border">
            <img
              src={c.image}
              alt={c.title}
              loading="lazy"
              className="min-w-32 w-32 md:w-full h-full object-cover rounded-[10px]"
            />
          </div>
